...
namespace BaiTapLon.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult TopMenu()
        {
            ...
            // 🔥 LÍ DO: đây là danh mục sách → bạn phải gửi Category về view
            ViewBag.Categories = new CategoryDraw().ListAllCategory(50);
