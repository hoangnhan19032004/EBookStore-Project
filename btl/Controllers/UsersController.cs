...
namespace BaiTapLon.Controllers
{
    public class UsersController : Controller
    {
        ...
        public JsonResult Login(LoginModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result == 1)
                {
                    ...
                    userSession.IDQuyen = user.IDQuyen;   // ✅ Thêm dòng này
                    ...
                    if (user.IDQuyen == 1)
                    {
                        ...
                        adminSession.userId = user.IDUser;
        ...
        public JsonResult EditUser(User entity)
        {
            ...
            userChange.Address = entity.Address;
                    ...
                    if (user.IsValidEmail(entity.Email) == true)
                    {
                        if (user.CheckSDT(entity.Phone) == true)
                        {
                            ...
                            if (result == true)
                            {
                                ...
                                userSession.address = userAdd.Address;
        ...
        [HttpGet]
        public ActionResult DanhSachHang(long id, string searchString, int page = 1, int pagesize = 5)
        {
            if (Session[Constant.USER_SESSION] != null)
            {
                var orderUser = new UserDraw().ListALLHoaDonUSer(id, searchString, page, pagesize);
        ...
        [HttpGet]
        public ActionResult MessengerUser(long id, string searchString, int page = 1, int pagesize = 5)
        {
            if (Session[Constant.USER_SESSION] != null)
            {

                var orderUser = new MessengerDraw().listTinNhanUser(id, searchString, page, pagesize);
        ...
        [HttpGet]
        public ActionResult MessengerReply(long id, string searchString, int page = 1, int pagesize = 5)
        {
            if (Session[Constant.USER_SESSION] != null)
            {

                var feedBack = new MessengerDraw().listTinNhanFeedBack(id, searchString, page, pagesize);
        ...
        public ActionResult FacebookCallback(string code)
        {
            ...
            if (!string.IsNullOrEmpty(accessToken))
            {
                ...
                if (addUserr > 0)
                {
                    ...
                    userSession.address = usergetByID.Address;
