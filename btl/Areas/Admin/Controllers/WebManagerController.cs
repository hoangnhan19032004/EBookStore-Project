...
namespace BaiTapLon.Areas.Admin.Controllers
{
    public class WebManagerController : BaseController
    {
        ...
        public ActionResult Menu(string searchString, int page = 1, int pagesize = 5)
        {
            var modelMenu = new MenuDraw().listMenu(searchString, page, pagesize);
        ...
        public ActionResult Silder(string searchString, int page = 1, int pagesize = 5)
        {
            var modelSilder = new SildeDraw().listSilderView(searchString, page, pagesize);
