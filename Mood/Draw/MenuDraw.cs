...
namespace Mood.Draw
{
    public class MenuDraw
    {
        ...
        public IEnumerable<MeNuModelView> listMenu(string searchString, int page,int pagesize)
        {
            dynamic result;
            if (!string.IsNullOrEmpty(searchString))
            {
                result = (from a in db.MenuType
                          ...
                          where b.NameMenu.Equals(searchString) || a.NameType.Equals(searchString)
