...
namespace Mood.Draw
{
    public class Order_DetailDraw
    {
        ...
        public IEnumerable<ChiTietHoaDon> chiTietHoaDon(long id, string searchString, int page, int pagesize)
        {
            dynamic result;
        ...
        public List<ChiTietHoaDon> dataExport(long id, string searchString)
        {
            dynamic result;
            if (!string.IsNullOrEmpty(searchString))
            {
