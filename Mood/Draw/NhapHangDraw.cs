...
namespace Mood.Draw
{
    public class NhapHangDraw
    {
        ...
        public IEnumerable<NhapHangModelView> nhapHangView(string searchString, int page, int pagesize)
        {
            dynamic result;
            if (!string.IsNullOrEmpty(searchString))
            {
                result = (from a in db.NhapHangs
                          join b in db.Sanphams on a.IDSanPham equals b.IDContent
                          join c in db.NhaCungCaps on a.IDNCC equals c.IDNCC
                          where b.Name.Contains(searchString) && a.Status == 0 || c.TenNCC.Contains(searchString) && a.Status == 0
                          select new NhapHangModelView()
                          {
                              IDNhapHang = a.IDNhapHang,
                              IDContent = b.IDContent,
        ...
        public IEnumerable<NhapHangModelView> DuyetView(string searchString, int page, int pagesize)
        {
            dynamic result;
            if (!string.IsNullOrEmpty(searchString))
            {
                result = (from a in db.NhapHangs
                          join b in db.Sanphams on a.IDSanPham equals b.IDContent
                          join c in db.NhaCungCaps on a.IDNCC equals c.IDNCC
                          where b.Name.Contains(searchString) && a.Status == 0 || a.Status == 1 || c.TenNCC.Contains(searchString) && a.Status == 0 || a.Status ==1
                          select new NhapHangModelView()
                          {
                              IDNhapHang = a.IDNhapHang,
                              IDContent = b.IDContent,
        ...
        public IEnumerable<NhapHangModelView> nhapKhoView(string searchString, int page, int pagesize)
        {
            dynamic result;
            if (!string.IsNullOrEmpty(searchString))
            {
                result = (from a in db.NhapHangs
                          join b in db.Sanphams on a.IDSanPham equals b.IDContent
                          join c in db.NhaCungCaps on a.IDNCC equals c.IDNCC
                          where b.Name.Contains(searchString) && a.Status == 1 || c.TenNCC.Contains(searchString) && a.Status == 1
                          select new NhapHangModelView()
                          {
                              IDNhapHang = a.IDNhapHang,
                              IDContent = b.IDContent,
        ...
        public IEnumerable<NhapHangModelView> nhapHoanThanhView(string searchString, int page, int pagesize)
        {
            dynamic result;
            if (!string.IsNullOrEmpty(searchString))
            {
                result = (from a in db.NhapHangs
                          join b in db.Sanphams on a.IDSanPham equals b.IDContent
                          join c in db.NhaCungCaps on a.IDNCC equals c.IDNCC
                          where b.Name.Contains(searchString) && a.Status == 2 || c.TenNCC.Contains(searchString) && a.Status == 2
                          select new NhapHangModelView()
                          {
                              IDNhapHang = a.IDNhapHang,
                              IDContent = b.IDContent,
