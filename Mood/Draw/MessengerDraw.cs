...
namespace Mood.Draw
{
    public class MessengerDraw
    {
        ...
        public IEnumerable<Orders> listTinNhanUser(long id, string searchString, int page, int pageSize)
        {
        ...
        public IEnumerable<Feed_Back> listTinNhanFeedBack(long id, string searchString, int page, int pageSize)
        {
