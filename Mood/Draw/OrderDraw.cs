...
namespace Mood.Draw
{
    public class OrderDraw
    {
        ...
        public IEnumerable<Orders> ListALL(string searchString, int page, int pageSize)
        {
        ...
        public IEnumerable<Orders> listChoGiao(string searchString, int page, int pageSize)
        {
        ...
        public IEnumerable<Orders> listXuatKho(string searchString, int page, int pageSize)
        {
        ...
        public IEnumerable<Orders> listHoanThanh(string searchString, int page, int pageSize)
        {
        ...
        public IEnumerable<Orders> listTraLai(string searchString, int page, int pageSize)
        {
        ...
        public IEnumerable<ChiTietHoaDon> giaoHang(string searchString, int page, int pagesize)
        {
            dynamic result;
            if (!string.IsNullOrEmpty(searchString))
            {
                result = (from a in db.Oders
                          ...
                          where a.Status == 1 && a.GiaoHang == 0 && c.Name.Contains(searchString) || a.Status == 1 && a.GiaoHang == 0 && a.ShipName.Contains(searchString)
        ...
        public IEnumerable<ChiTietHoaDon> hoanThanh(string searchString, int page, int pagesize)
        {
            dynamic result;
            if (!string.IsNullOrEmpty(searchString))
            {
                result = (from a in db.Oders
                          join b in db.Oder_Details on a.IDOder equals b.OderID
                          join c in db.Sanphams on b.ProductID equals c.IDContent
                          where a.Status == 1 && a.GiaoHang == 1 && c.Name.Contains(searchString) || a.Status == 1 && a.GiaoHang == 1 && a.ShipName.Contains(searchString)
                          select new ChiTietHoaDon()
                          {
                              OderID = a.IDOder,
                              TenKH = a.ShipName,
