...
namespace Mood.Draw
{
    public class SanphamDraw
    {
        ...
        public IEnumerable<SanPhamModel> sachcu(string searchString, int page, int pagesize)
        {
            dynamic result;
            if (!string.IsNullOrEmpty(searchString))
            {
                result = (from a in db.Categories
                          ...
                          where b.Name.Contains(searchString) && b.Quanlity == "cũ nát" || b.TacGia.Contains(searchString)&& b.Quanlity == "cũ nát" || a.TenTheloai.Contains(searchString) && b.Quanlity =="cũ nát" || c.TenNCC.Contains(searchString) && b.Quanlity == "cũ nát" || f.UserName.Contains(searchString) && b.Quanlity == "cũ nát"
        ...
        public IEnumerable<Sanpham> hetHang(string searchString, int page, int pagesize)
        {
            IQueryable<Sanpham> model = db.Sanphams.Where(x=>x.TonKho ==0);
            if (!string.IsNullOrEmpty(searchString))
            {
                model = model.Where(x => x.Name.Contains(searchString) || x.TacGia.Contains(searchString));
        ...
        public IEnumerable<Sanpham> listProduct(string searchString, int page, int pagesize)
        {
        ...
        public IEnumerable<SanPhamModel> listTheloai(string searchString,int page,int pagesize)
        {
            dynamic result;
            if (!string.IsNullOrEmpty(searchString))
            {
                 result = (from a in db.Categories
                           join b in db.Sanphams on a.IDCategory equals b.CategoryID
                           where b.Name.Contains(searchString) || b.TacGia.Contains(searchString) || a.TenTheloai.Contains(searchString)
                              select new SanPhamModel()
                              {
                                  IDContent = b.IDContent,
                                  Name = b.Name,
        ...
        public IEnumerable<SanPhamModel> listKhoHang(string searchString, int page, int pagesize)
        {
            dynamic result;
            if (!string.IsNullOrEmpty(searchString))
            {
        ...
        public IEnumerable<SanPhamModel> getByIDcate(long idCate,string searchString,int page,int pageSize)
        {
            dynamic result;
            if (!string.IsNullOrEmpty(searchString))
            {
                result = (from a in db.Categories
                          join b in db.Sanphams on a.IDCategory equals b.CategoryID
                          where b.CategoryID == idCate && b.Name.Contains(searchString) || b.CategoryID == idCate && b.TacGia.Contains(searchString) || a.TenTheloai.Contains(searchString)
                          select new SanPhamModel()
                          {
                              IDContent = b.IDContent,
                              Name = b.Name,
